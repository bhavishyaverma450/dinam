...
export const AGENT_TOOL_DEFINITIONS: Record<string, unknown>[] = [
    {
        ...
        function: {
            ...
            description:
                "List all focus tasks with id, label, and done status.",
...
export async function executeAgentTool(
    ...
    switch (name) {
        ...
        case "dashboard_add_quick_launch": {
            ...
            const icon =
                iconRaw && isQuickLaunchIconKey(iconRaw)
                    ? iconRaw
                    : undefined
        ...
        case "browser_read_clipboard": {
            try {
                ...
                return {
                    error:
                        e instanceof Error ? e.message : "clipboard read failed",
                }
            }
        }
        ...
        case "window_scroll": {
            ...
            const behavior =
                str(args.behavior) === "smooth" ? "smooth" : "auto"
            window.scrollTo({
